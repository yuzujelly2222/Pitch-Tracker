...
※pybaseball で取得したデータを使用しているため、本来想定していたデータ形式とは一部異なり、挙動が異なる箇所があります。<br>

※Windows 環境向けにフォント設定を変更しています。
...
x,yのスケールに-を含めたり全体を小さすぎる値にすると表示の挙動がおかしくなる問題があります.<br>
[8. 座標位置を調整](###8.座標位置を調整)のような値にするとうまくいきます.
